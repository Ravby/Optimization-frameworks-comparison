...
def goldsteinPrice(individual):
    term1 = (1 + ((individual[0] + individual[1] + 1) ** 2) * (
            19 - 14 * individual[0] + 3 * individual[0] ** 2 - 14 * individual[1] + 6 * individual[0] * individual[1] + 3 *
            individual[1] ** 2))
    term2 = (30 + ((2 * individual[0] - 3 * individual[1]) ** 2) * (
            18 - 32 * individual[0] + 12 * individual[0] ** 2 + 48 * individual[1] - 36 * individual[0] * individual[1] + 27 *
            individual[1] ** 2))
    return term1 * term2,
