...
#ifndef PAGMO_PROBLEMS_rastriginShifted_SHIFTED_HPP
#define PAGMO_PROBLEMS_rastriginShifted_SHIFTED_HPP
...
/// The rastriginShifted problem.
/**
 * \image html rastriginShifted.png "Two-dimensional rastriginShifted function." width=3cm
 *
 * This is a scalable box-constrained continuous single-objective problem.
 * The objective function is the generalised n-dimensional rastriginShifted function:
 * \f[
 ...
 */
struct PAGMO_DLL_PUBLIC rastriginShifted {
    /// Constructor from dimension
    /**
     * Constructs a rastriginShifted problem
     *
     * @param dim the problem dimensions.
     *
     * @throw std::invalid_argument if \p dim is < 1
     */
    rastriginShifted(unsigned dim = 1u);
    ...
    {
        return "rastriginShifted Function";
    }
...
PAGMO_S11N_PROBLEM_EXPORT_KEY(pagmo::rastriginShifted)
