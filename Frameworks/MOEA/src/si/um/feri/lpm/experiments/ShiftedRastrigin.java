...
public class ShiftedRastrigin extends LoggingAbstractProblem {
     ...
     */
    public ShiftedRastrigin(Integer numberOfVariables) {
    ...
    public void computeFitness(Solution solution) {
        ...
        for (int i = 0; i < numberOfVariables; i++) {
            result += shiftedX[i] * shiftedX[i] - a * Math.cos(w * shiftedX[i]);
        }
