...
class Schwefel12Shifted(Problem):
    def __init__(self, bounds=None, minmax="min", name="SchwefelShifted", **kwargs):
    ...
    def obj_func(self, solution):
        solution2 = solution - Schwefel12Shifted.shift

        return np.sum([np.sum(solution2[:i]) ** 2
